...
new TypeIt("#teks1", {
  strings: ["Today, Is your birthday mayang.", "Semoga hal-hal yang membuat kamu runtuh turut menjadi alasan kamu untuk tetap tumbuh.", "Semoga dunia senantiasa menjaga kamu dimanapun kamu berada.", "Semoga hari-hari kamu selalu diiringi cinta yang tak pernah ada batasnya." , "Semoga setiap langkahmu dimudahkan hingga tercapai apa yang kamu inginkan."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["semoga semesta selalu membahagiakan kamu bagimanapun caranya.", " ", "barakallah fi umrik.", " ", "- Wish all you the best Mayang permata !"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
